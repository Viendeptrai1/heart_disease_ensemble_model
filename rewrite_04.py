...
# Cell 3: Metrics
cell4 = nbf.v4.new_code_cell("""cv = StratifiedKFold(n_splits=N_FOLDS, shuffle=True, random_state=RANDOM_STATE)
...
cell5 = nbf.v4.new_markdown_cell("## 2. Random Forest")
cell6 = nbf.v4.new_code_cell("""def obj_rf(trial):
    params = {
...
# Cell 5: XGBoost
cell7 = nbf.v4.new_markdown_cell("## 3. XGBoost")
cell8 = nbf.v4.new_code_cell("""def obj_xgb(trial):
    params = {
        'n_estimators': trial.suggest_int('n_estimators', 50, 300),
...
# Cell 6: LightGBM
cell9 = nbf.v4.new_markdown_cell("## 4. LightGBM")
cell10 = nbf.v4.new_code_cell("""def obj_lgbm(trial):
    params = {
        'n_estimators': trial.suggest_int('n_estimators', 50, 300),
        'max_depth': trial.suggest_int('max_depth', 3, 15),
        'learning_rate': trial.suggest_float('learning_rate', 0.01, 0.3, log=True),
...
# Cell 7: Voting Classifier
cell11 = nbf.v4.new_markdown_cell("## 5. Voting Classifier (Soft)")
cell12 = nbf.v4.new_code_cell("""# Define estimators with pipelines where needed
estimators = [
...
# Cell 8: Stacking Classifier
cell13 = nbf.v4.new_markdown_cell("## 6. Stacking Classifier")
cell14 = nbf.v4.new_code_cell("""# Using same estimators as Voting
...
# Cell 9: Save Results
cell15 = nbf.v4.new_code_cell("""df_results = pd.DataFrame(ensemble_results).T
df_results.to_csv('outputs/ensemble_models_results.csv')
print("✅ Results saved to outputs/ensemble_models_results.csv")
print(df_results)""")

nb.cells = [cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15]

with open('/Users/kotori/a_benh_tim/04_EnsembleModels.ipynb', 'w', encoding='utf-8') as f:
    nbf.write(nb, f)
